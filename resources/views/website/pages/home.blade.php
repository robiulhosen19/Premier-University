...
@section('content')
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('assets/website/images/hero_1.jpg'); ">
        <div class="container">
          ...
          <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
            ...
            <div class="feature-1 border">
              ...
              <div class="feature-1-content">
                ...
                <p>Premier University has been imparting quality education since its inception. The development of a quality educational system of Premier University largely lies on its committed and highly qualified members of the faculty, supportive administration and large pool of learning resources. </p>
              ...
              <div class="owl-slide-3 owl-carousel">
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="assets/website/images/course_1.jpg" alt="Image" class="img-fluid"></a>
        ...
        <div class="row">
          <div class="col-lg-4">
            <h2 class="section-title-underline style-2">
              <span>Welcome To Premier University</span>
            </h2>
          </div>
          <div class="col-lg-8">
            <p>Premier University was first established in the year 2002. According to an international educational survey conducted by Australian government, it recieved a position of "A" category university.It attaches the peramount importance to the quality of education which imparts to the students. Anyone who wants to enrich himself or herself in knowledge is welcome here. The aim is to provide high quality education to the students and at the same time to embue them with the finest qualities of humanism so that they will be ready to sacrifice themselves for the peace and prosperity of humanity. No parochialism, communalism or bigotry will be allowed to play any part in this university.</p>
        ...
        <div class="owl-slide owl-carousel">
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="assets/website/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Prof. Dr. Anupam Sen</h3>
                <span>professor</span>
              </div>
            </div>
            <div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="post-entry-big">
                  <a href="news-single.html" class="img-link"><img src="assets/website/images/blog_large_1.jpg" alt="Image" class="img-fluid"></a>
              ...
              <div class="col-lg-6">
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="assets/website/images/blog_1.jpg" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
                ...
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="assets/website/images/blog_2.jpg" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
